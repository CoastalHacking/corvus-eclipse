 ...
 * </p>
 * <ul>
 *   <li>{@link us.coastalhacking.corvus.eclipse.resources.impl.IContainerImpl#getMembers <em>Members</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IContainerImpl extends IResourceImpl implements IContainer {
	...
	protected EClass eStaticClass() {
		return EclipseResourcesPackage.Literals.ICONTAINER;
	}
	...
	public EList<IResource> getMembers() {
		if (members == null) {
			members = new EObjectContainmentWithInverseEList<IResource>(IResource.class, this, EclipseResourcesPackage.ICONTAINER__MEMBERS, EclipseResourcesPackage.IRESOURCE__PARENT);
		}
		return members;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case EclipseResourcesPackage.ICONTAINER__MEMBERS:
