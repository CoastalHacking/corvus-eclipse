...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Marker Entry Point</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link us.coastalhacking.corvus.semiotics.impl.MarkerEntryPointImpl#getKey <em>Key</em>}</li>
 *   <li>{@link us.coastalhacking.corvus.semiotics.impl.MarkerEntryPointImpl#getSignifieds <em>Signifieds</em>}</li>
 *   <li>{@link us.coastalhacking.corvus.semiotics.impl.MarkerEntryPointImpl#getUuid <em>Uuid</em>}</li>
 *   <li>{@link us.coastalhacking.corvus.semiotics.impl.MarkerEntryPointImpl#getSignifiers <em>Signifiers</em>}</li>
 *   <li>{@link us.coastalhacking.corvus.semiotics.impl.MarkerEntryPointImpl#getRoot <em>Root</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MarkerEntryPointImpl extends MinimalEObjectImpl.Container implements MarkerEntryPoint {
	/**
	 ...
	 * @generated
	 */
	protected MarkerEntryPointImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return SemioticsPackage.Literals.MARKER_ENTRY_POINT;
	}
	...
	public void setKey(String newKey) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SemioticsPackage.MARKER_ENTRY_POINT__KEY, oldKey, key));
	}
	...
	public EList<Signified> getSignifieds() {
		if (signifieds == null) {
			signifieds = new EObjectWithInverseResolvingEList.ManyInverse<Signified>(Signified.class, this, SemioticsPackage.MARKER_ENTRY_POINT__SIGNIFIEDS, SemioticsPackage.SIGNIFIED__SIGNIFIERS);
		}
		return signifieds;
	}
	...
	public void setUuid(String newUuid) {
		...
		uuid = newUuid;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SemioticsPackage.MARKER_ENTRY_POINT__UUID, oldUuid, uuid));
	}
	...
	public EList<Signifier> getSignifiers() {
		if (signifiers == null) {
			signifiers = new EObjectWithInverseResolvingEList.ManyInverse<Signifier>(Signifier.class, this, SemioticsPackage.MARKER_ENTRY_POINT__SIGNIFIERS, SemioticsPackage.SIGNIFIER__SIGNIFIEDS);
		}
		return signifiers;
	}
	 ...
	 */
	public Root getRoot() {
		if (eContainerFeatureID() != SemioticsPackage.MARKER_ENTRY_POINT__ROOT) return null;
	...
	public NotificationChain basicSetRoot(Root newRoot, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newRoot, SemioticsPackage.MARKER_ENTRY_POINT__ROOT, msgs);
		return msgs;
	}
	...
	public void setRoot(Root newRoot) {
		if (newRoot != eInternalContainer() || (eContainerFeatureID() != SemioticsPackage.MARKER_ENTRY_POINT__ROOT && newRoot != null)) {
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == Signified.class) {
			switch (baseFeatureID) {
				...
				case SemioticsPackage.SIGNIFIED__SIGNIFIERS: return SemioticsPackage.MARKER_ENTRY_POINT__SIGNIFIERS;
				default: return -1;
			}
		}
