/**
 */
package us.coastalhacking.corvus.entrypoint.util;
...
import us.coastalhacking.corvus.entrypoint.*;
 ...
 * @generated
 */
public class EntrypointSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	protected static EntrypointPackage modelPackage;
	 ...
	 * @generated
	 */
	public EntrypointSwitch() {
		if (modelPackage == null) {
			modelPackage = EntrypointPackage.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case EntrypointPackage.ENTRY_POINT_ROOT: {
				EntryPointRoot entryPointRoot = (EntryPointRoot)theEObject;
				T result = caseEntryPointRoot(entryPointRoot);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case EntrypointPackage.ENTRY_POINT: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Entry Point Root</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Entry Point Root</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseEntryPointRoot(EntryPointRoot object) {
		return null;
	}
