/**
 */
package us.coastalhacking.corvus.eclipse.runtime.util;
 ...
 * <!-- end-user-doc -->
 * @see us.coastalhacking.corvus.eclipse.runtime.EclipseRuntimePackage
 * @generated
 */
public class EclipseRuntimeSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	protected static EclipseRuntimePackage modelPackage;
	 ...
	 * @generated
	 */
	public EclipseRuntimeSwitch() {
		if (modelPackage == null) {
			modelPackage = EclipseRuntimePackage.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case EclipseRuntimePackage.IPATH: {
				IPath iPath = (IPath)theEObject;
				T result = caseIPath(iPath);
				if (result == null) result = caseSemiotics(iPath);
				if (result == null) result = caseSignifier(iPath);
				if (result == null) result = caseSignified(iPath);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>IPath</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>IPath</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseIPath(IPath object) {
		return null;
	}
